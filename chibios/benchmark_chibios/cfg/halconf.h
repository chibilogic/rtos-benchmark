 ...
 */
/* ADR-014 strada A1: TIM2 is driven directly by test_ctxsw_irq.c
 * (custom IRQ handler with CC1 source); we no longer use the GPT
 * driver. Keep HAL_USE_GPT=FALSE to drop unused code. */
